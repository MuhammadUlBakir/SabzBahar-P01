...
//-----------------------
const sortOptions = [
{ name: 'All Plants', href: '#', current: true },
  { name: 'Flower Plants', href: '#', current: false },
  { name: 'Indoor Plants', href: '#', current: false },
  { name: 'Outdoor Plants', href: '#', current: false },
          ...
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
            ...
            <div className="flex items-center">
              <Menu as="div" className="relative inline-block text-left " >
                <div>
                  <Menu.Button className="group inline-flex justify-center text-sm font-medium text-white-700 hover:text-gray">
                    Sort
                    <ChevronDownIcon
