...
<Orderpage>
<div className="mt-10 border border-grey px-4 pt-8 lg:mt-0" style={{borderRadius : "10px" , backgroundColor : theme ? (theme !== "dark" ? "#2f3733" : "white") : (themedata == "dark" ? "#2f3733" : "white")}} data-aos = "fade-down" data-aos-duration = "3000">
...
<div className="px-4 pt-8" style={{marginTop : "30px"}} data-aos = "fade-down" data-aos-duration = "3000">
