...
const filters = [
  {
    ...
    name: 'Category',
    options: [
      { value: 'Flower', label: 'New Arrivals', checked: false },
      { value: 'Nonflower', label: 'Sale', checked: false },
      { value: 'Outdoor', label: 'Travel', checked: true },
      { value: 'Indoor', label: 'Organization', checked: false },
      { value: 'Succulents', label: 'Accessories', checked: false },
      { value: 'Medicinal', label: 'Accessories', checked: false },
...
export default function Product_Filter () {
  ...
  const LowtoHigh = async () => {
    try {
      const productdata = await axios.get("https://good-cyan-angler-wrap.cyclic.cloud/api/getproduct");
      const Filterproduct = productdata.data.Allproduct.filter(elm => elm.productcategory === cname);
      ...
      <div>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
              <h1 className="text-3xl font-bold tracking-tight text-gray-900">{cname} Plants</h1>
